  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        scrolledUnderElevation: 0, // Prevent blur effect on scroll
        toolbarHeight: 0,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(icon: const Icon(Icons.skip_previous_rounded, size: 40, color: Colors.white), onPressed: () => _sendCommand("previous")),
              GestureDetector(
              ...
              IconButton(icon: const Icon(Icons.skip_next_rounded, size: 40, color: Colors.white), onPressed: () => _sendCommand("next")),
              IconButton(
                icon: Icon(
